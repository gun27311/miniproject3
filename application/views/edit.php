            ...
            <div id=inner class="col-sm-7">
                <form action="<?php echo base_url(); ?>index.php/main/editcommand/<?php echo $Command_id; ?>" method='POST'>
                        ...
                        foreach($memberlist as $key=>$row){
                            ...
                            echo "<tr>";
                                echo "<td>
                                    ...
                                    <td width='0'><input value='' type='hidden' name='prolist[]' required class='form-control' id='pwd' placeholder='โปรดใส่ตำแหน่ง'></td>";
                    ...
                    <div class="form-group">
                        ...
                        <h3>สถานะ</h3>
                        <input type=radio value='Active' name=status checked> Active <input type=radio value='expine' name=status> Expired
                    </div>
                    <button type="submit" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-pencil"></span>แก้ใข</button> 
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#addmember').click(function() {
                    $(this).before("<tr><td><input type='text'  name='memberlist[]' class='form-control' placeholder='โปรดใส่ชื่อกรรมการ'></td><td><button type=button id=remove class='btn btn-default'>ลบ</button></td></tr><tr id=nonshow><td id=nonshow>&nbsp;</td></tr>");
                })
